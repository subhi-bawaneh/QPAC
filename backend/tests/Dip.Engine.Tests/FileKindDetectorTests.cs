...
public class FileKindDetectorTests
{
    ...
    // The workbooks are just as often named by hand as by the coded scheme.
    [InlineData("TIDP-STL.xlsx", FileKind.Tidp)]
    [InlineData("TIDP-STL-AFCO.xlsx", FileKind.Tidp)]
    [InlineData("MIDP.xlsx", FileKind.Midp)]
    [InlineData("midp.xlsx", FileKind.Midp)]
