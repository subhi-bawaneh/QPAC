...
[Route("api/projects/{projectId:guid}/picklists/upload")]
[Authorize]
public sealed class UploadPicklistsController : ApiControllerBase
{
        ...
        Guid projectId, IFormFile file, CancellationToken ct = default)
    {
        ...
        return Accepted(await Dispatcher.Send(
            new UploadPicklistsCommand(projectId, file.FileName, buffer.ToArray()), ct));
    }
}
