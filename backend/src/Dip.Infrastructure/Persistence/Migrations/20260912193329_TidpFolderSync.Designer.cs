...
namespace Dip.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912193329_TidpFolderSync")]
    partial class TidpFolderSync
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dip.Domain.Entities.TidpFile", b =>
                {
                    ...
                    b.Property<string>("DisciplineTag")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<Guid?>("FolderDisciplineId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NameOriginator")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("NameProjectCode")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.HasIndex("FolderDisciplineId");

                    b.HasIndex("OwnerId");

                    b.HasIndex("ProjectId", "DisciplineId");

                    b.HasIndex("ProjectId", "DisciplineTag");
            ...
            modelBuilder.Entity("Dip.Domain.Entities.TidpFolderDiscipline", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TidpFolderDisciplines", (string)null);
                });

            modelBuilder.Entity("Dip.Domain.Entities.TidpFolderOwner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TidpFolderOwners", (string)null);
                });

            modelBuilder.Entity("Dip.Domain.Entities.TidpFolderSync", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TidpFolderSyncs", (string)null);
                });
            ...
            modelBuilder.Entity("Dip.Domain.Entities.DocumentSnapshot", b =>
                {
                    ...
                    b.HasOne("Dip.Domain.Entities.Project", null)
                        .WithMany()
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Dip.Domain.Entities.TidpFile", null)
                        .WithMany()
                        .HasForeignKey("TidpFileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dip.Domain.Entities.TidpFile", b =>
                {
                    ...
                    b.HasOne("Dip.Domain.Entities.TidpFolderDiscipline", "FolderDiscipline")
                        .WithMany()
                        .HasForeignKey("FolderDisciplineId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Dip.Domain.Entities.TidpFolderOwner", "Owner")
                        .WithMany()
